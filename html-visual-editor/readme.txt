...
= 1.1.2 =
* Correcao: os outlines de selecao (azul no hover, verde ao clicar) voltam a aparecer. As variaveis de cor eram declaradas apenas em `#hve-root`, mas o SelectionManager as aplica nos elementos da pagina, fora desse container — o `var()` ficava invalido e o outline nunca renderizava.
